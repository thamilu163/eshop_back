...
$res = Invoke-RestMethod -Uri "http://localhost:8080/admin/realms/eshop/users?username=admin" -Headers @{Authorization="Bearer $token"}
$res | ConvertTo-Json | Out-File g:\Project\eshop_back\kc_admin_users.json
